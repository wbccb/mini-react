...
const EventInterface = {
  ...
  bubbles: 0,
  cancelable: 0,
  timeStamp: function(event: any) {
    return event.timeStamp || Date.now();
  },
  defaultPrevented: 0,
  isTrusted: 0,
} as EventInterfaceType;
...
let lastMovementX:any;
let lastMovementY:any;
let lastMouseEvent:any;

function updateMouseMovementPolyfillState(event: any) {
 ...
 */
function getEventKey(nativeEvent: any) {
  if (nativeEvent.key) {
...
function modifierStateGetter(keyArg: any) {
